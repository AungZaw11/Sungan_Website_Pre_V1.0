    ...
    <div className="flex flex-col w-full">
      ...
      <section className="relative h-[600px] md:h-[722px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-4xl mx-auto px-4 text-center">
          ...
          >
            The purpose of the company's establishment is to provide total
            solution services for ship management.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div>
              ...
              <p className="text-lg text-primary font-medium">Company Philosophy</p>
            </div>
            ...
            <div className="space-y-6">
              ...
              {/* Card 3 */}
              <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-lg transition-shadow">
                <h3 className="text-xl font-bold text-primary mb-2">Customer Profit Creation</h3>
                <p className="text-body">
                  Creating customer profits through continuous development.
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            >
              ...
              <h3 className="text-2xl font-semibold text-heading mb-4">{service.title}</h3>
              <p className="text-body mb-8 flex-grow">{service.desc}</p>
              <Link to="/services" className="font-medium flex items-center gap-2 hover:underline mt-auto" style={{ color: '#dc2626' }}>
                View More <FaArrowRight className="w-4 h-4" />
              </Link>
            </motion.div>
          ))}
